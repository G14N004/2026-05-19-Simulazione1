...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._ddGenre = ft.Dropdown(label="paese", width=250)
        ...
        self._ddArtist = ft.Dropdown(label="genere", width=250)
        self._btnCreaGrafo = ft.ElevatedButton(text="Trova Cammino", on_click=self._controller.handleCreaGrafo, width=250)
